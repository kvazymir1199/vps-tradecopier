...
| 2026-07-08 04:46 | Hub restarted (PID 7364 → 10928) | **Manual restart by operator.** `hub_started` alert delivered. Official window starts here |
| 2026-07-08 ~04:46 | slave_52911415 NACK burst begins (53 NACKs `ORDER_FAILED` in first hour) | **Account ran out of funds** — broker rejected every order, Slave EA NACKed with `ORDER_FAILED`. `consecutive_nacks` + `alert_storm` alerts fired, dedup engaged. Slave later replaced with funded account 52953732 |
| 2026-07-09 ~04:00 | Master heartbeat gaps: master_1715542650 138 s, master_67185418 469 s (2 gaps) | **Nightly VPS maintenance.** 3 `heartbeat_miss` alerts delivered — detection verified live |
| 2026-07-09 04:52 | slave_52911415 (IC Markets) disconnected | `slave_disconnected` alert delivered |
| 2026-07-09 04:53 | slave_52953732 (IC Markets) registered as replacement | New funded account on same broker; ReportHistory-52953732.xlsx exported from it |
| 2026-07-09 05:01–05:02 | Links master_1715542650/master_67185418 → slave_52953732 created in web panel | Trades opened 04:53–04:59 (7 OPENs) correctly NOT copied to it — links did not exist yet (verified by reconciliation) |
